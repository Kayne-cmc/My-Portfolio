      ...
      <div>
        <Slider {...settings}>
          ...
          <div className="container">
            ...
            <div className="image-content">
              <p>Working with 3D printing, my group and I printed parts to create a wind up climbing toy</p>
          ...
          <div className="container">
            <img src={Welding}></img>
            <div className="image-content">
              <p>With some robotC coding, my group and I have programmed a robot to pick up objects.</p>
