  ...
  return (
    <div className="App">
      <div className="dropdown">
        ...
        <p className="text">
          Hi I'm Kayne and I am a 2A Mechanical Engineering student at the University of Waterloo. Ever since I was a kid, I would always visualize designs in my head. Whether its a solution or a design, every problem or difficult situation that I encounter, I would come up with a solution in my head. Without the proper experience, I was unable to make my designs come to life. As a future engineer I still hold the same goal I had as a child-to create awesome things that help others.
        </p>        
